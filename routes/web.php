...
# Ventas
Route::get('/portal/get-ventas-form', 'PortalController@getVentasForm');
Route::any('/portal/online', 'PortalController@online');
Route::any('/portal/totals', 'PortalController@totals');
Route::any('/portal/history', 'PortalController@history');
Route::any('/portal/summaryPerDay', 'PortalController@summaryPerDay');

# Abonos
Route::get('/portal/get-abonos-form', 'PortalController@getAbonosForm');
Route::any('/portal/byAccounts', 'PortalController@byAccounts');
Route::any('/portal/salesForPayments', 'PortalController@salesForPayments');
Route::any('/portal/upcoming', 'PortalController@upcoming');
Route::any('/portal/completed', 'PortalController@completed');
